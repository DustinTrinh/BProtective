...
class JustTesting: UIViewController {
    ...
    @IBAction func addData(_ sender: UIButton) {
        ...
        var dict2 = ["Username" : "test2", "Privacy" : "3"]
        var dict3 = ["Username" : "test3" , "Privacy" : "2"]
    ...
    @IBAction func append(_ sender: UIButton) {
        var testing = ["Username": "test19", "Privacy": "1"]
                    ...
                    if let err = err {
                        ...
                        for document in querySnapshot!.documents {
                            ...
                            for data in saveData1 {
                                print("Username Bonds: \(data["Username"])")
    ...
    func appendDataForeign(dataList: [String:String]){
        ...
        var foreignUsername = dataList["Username"] as! String
        if let username = Auth.auth().currentUser?.email{
            
            var foreignArray = ["Username": username as! String, "Privacy": dataList["Privacy"] as! String]
