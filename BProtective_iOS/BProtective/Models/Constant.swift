...
struct K {
    ...
    struct Messages{
        ...
        static let changedPasswordSuccessfully = "You successfully changed your password"
        ...
        // Changed to a more ambiguous error return to cover more use cases
        static let bondSelf = "Invalid bond code"
    }
